...
() {
  ...
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_FOREGROUND=9
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_RUST_VERSION_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_DOTNET_VERSION_BACKGROUND=8
